import { A as AstroError, v as MissingSharp } from './entrypoint_K_eWHUp6.mjs';
import { b as baseService, p as parseQuality } from './generic_DNzlKStd.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_02YGBSJv.mjs').then(n => n.i)).default;
  } catch {
